...
Namespace CustomTableOfContents
	...
	Partial Public Class nwindDataSet
		...
		Partial Public Class ProductsDataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
			Public Function AddProductsRow(ByVal ProductName As String, ByVal SupplierID As Integer, ByVal parentCategoriesRowByCategoriesProducts As CategoriesRow, ByVal QuantityPerUnit As String, ByVal UnitPrice As Decimal, ByVal UnitsInStock As Short, ByVal UnitsOnOrder As Short, ByVal ReorderLevel As Short, ByVal Discontinued As Boolean, ByVal EAN13 As String, ByVal CategoryName As String) As ProductsRow
				Dim rowProductsRow As ProductsRow = (DirectCast(Me.NewRow(), ProductsRow))
				Dim columnValuesArray() As Object = { Nothing, ProductName, SupplierID, Nothing, QuantityPerUnit, UnitPrice, UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued, EAN13, CategoryName}
	...
	End Class
End Namespace
Namespace CustomTableOfContents.nwindDataSetTableAdapters
	...
	Partial Public Class ProductsTableAdapter
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0) = New Global.System.Data.OleDb.OleDbCommand()
			Me._commandCollection(0).Connection = Me.Connection
			Me._commandCollection(0).CommandText = "SELECT        Products.ProductID, Products.ProductName, Products.SupplierID, Products.CategoryID, Products.QuantityPerUnit, Products.UnitPrice, Products.UnitsInStock, " & ControlChars.CrLf & _
"                         Products.UnitsOnOrder, Products.ReorderLevel, Products.Discontinued, Products.EAN13, Categories.CategoryName" & ControlChars.CrLf & _
"FROM            (Products INNER JOIN" & ControlChars.CrLf & _
